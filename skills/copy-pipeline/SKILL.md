...
```bash
cat marketing/brand/copy-examples/COPY-ANALYSIS.md
```
...
- `marketing/brand/VOICE.md` — voice profile and rules
- `ops/strategy/offer/undeniable-offer.md` — offer structure, pricing, positioning
- `marketing/brand/identity/02-icp.md` — who we're talking to
...
### 3a. Brand Voice
Read `marketing/brand/VOICE.md` for Chris's exact voice rules:
